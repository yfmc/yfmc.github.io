...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/willMoving.css">
<!-- ========== 컨텐츠 영역 시작 ========== -->
<div class="contentHeight">
    <div class="content">
        ...
        <div class="list_title">
            <h2>박스오피스</h2>
            <p>
                <button type="button" class="btn btn-danger btn-sm">현재 상영작</button>
                <button type="button" class="btn btn-primary btn-sm">상영 예정작</button>
            </p>
        </div>
        <div class="clearfix">
