...
(function(f) {
        ...
        for (var h = a.sDom.split(""), g, k, l, m, p, n, u = 0; u < h.length; u++) {
            ...
            if ("<" == k) {
                ...
                for (l = q.ext.feature, n = 0, m = l.length; n < m; n++)
                    if (k == l[n].cFeature) { g = l[n].fnInit(a); break } g && (l = a.aanFeatures, l[k] || (l[k] = []), l[k].push(g), e.append(g))
        }
        c.replaceWith(e);
        a.nHolding =
            null
    ...
    function Mb(a) {
        ...
        for (var d = 0, e = b.length; d < e; d++) {
            ...
            h.bSortable && (0 < c.length && c[0].col == d ? (f.setAttribute("aria-sort", "desc" == c[0].dir ? "ascending" : "descending"), h = g[c[0].index + 1] || g[0]) : h = g[0], k += "asc" === h ? a.sSortAscending : a.sSortDescending);
    ...
    var q = function(a) {
        ...
        sa = function(a) {
            a: { if (!(2 > a.length)) { var b = a.slice().sort(); for (var c = b[0], d = 1, e = b.length; d < e; d++) { if (b[d] === c) { b = !1; break a } c = b[d] } } b = !0 }
            ...
            for (c = d.length; a < c; a++) {
                ...
                a: {
                    ...
                    for (var l = e.length; k < l; k++)
                        if (e[k].name === g) { k = e[k]; break a } k = null
                }
                k || (k = {
                    name: g,
                    val: {},
    ...
    var db = function(a, b, c, d, e) {
            ...
            m = 0;
            for (k = b.length; m < k; m++) { var p = b[m] && b[m].split && !b[m].match(/[\[\(:]/) ? b[m].split(",") : [b[m]]; var q = 0; for (l = p.length; q < l; q++)(g = c("string" === typeof p[q] ? f.trim(p[q]) : p[q])) && g.length && (h = h.concat(g)) } a = C.selector[a];
            if (a.length)
    ...
    f.extend(!0, q.ext.renderer, {
        pageButton: {
            _: function(a, b,
                ...
                try { var x = f(b).find(w.activeElement).data("dt-idx") } catch (lc) {} t(f(b).empty(), d);
