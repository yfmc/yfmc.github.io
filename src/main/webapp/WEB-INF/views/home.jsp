	...
	<div class="article">
		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-3 col-xs-3">
				...
				<div class="thumb">
					<a href="#" class="thumbnail"> <img src="img/ar1.jpg" class="img-responsive" />
			...
			<div class="col-md-3 col-sm-3 col-xs-3">
				<!-- .thumbnail은 박스에 회색 테두리를 쳐준다. -->
				<div class="thumb">
					<a href="#" class="thumbnail"> <img src="img/ar2.jpg" class="img-responsive" />
			...
			<div class="col-md-3 col-sm-3 col-xs-3">
				<!-- .thumbnail은 박스에 회색 테두리를 쳐준다. -->
				<div class="thumb">
					<a href="#" class="thumbnail"> <img src="img/ar3.jfif" class="img-responsive" />
			...
			<div class="col-md-3 col-sm-3 col-xs-3">
				<!-- .thumbnail은 박스에 회색 테두리를 쳐준다. -->
				<div class="thumb">
					<a href="#" class="thumbnail"> <img src="img/ar4.jpg" class="img-responsive" />
