...
<div class="container">
	...
	<div class="movie-comment">
		<ul class="people-comment">
			<li><span>python</span>
				<div class="pulldate">
					<script type="text/Javascript" src="${pageContext.request.contextPath}/assets/js_files/pulldate.js"></script>
				</div>
				<div class="starRev">
					<span class="starR on">별1</span> <span class="starR on">별2</span> <span
			...
			<li><span>java</span>
				...
				<div class="starRev">
					<span class="starR on">별1</span> <span class="starR on">별2</span> <span
						class="starR on">별3</span> <span class="starR on">별4</span> <span
						class="starR">별5</span>
				</div> <span class="text1" id="text1">이 영화 정말 재미있습니다. 또 보고싶어지는
					영화입니다.</span> <%-- <button type="submit" class="btn btn-dark" style="float:right">등록하기</button>--%>
			</li>
			<li><span>mysql</span>
				<div class="pulldate">
					<script type="text/Javascript" src="${pageContext.request.contextPath}/assets/js_files/pulldate.js"></script>
			...
			<li><span>html</span>
				...
				<div class="starRev">
					<span class="starR on">별1</span> <span class="starR on">별2</span> <span
						class="starR">별3</span> <span class="starR">별4</span> <span
						class="starR">별5</span>
				</div> <span class="text1" id="text1">그럭저럭 볼만한 영화입니당 ㅎㅎ</span> <%--<button type="submit" class="btn btn-dark" style="float:right">등록하기</button>--%>
			</li>
			<li><span>css</span>
				<div class="pulldate">
					<script type="text/Javascript" src="${pageContext.request.contextPath}/assets/js_files/pulldate.js"></script>
				...
				<div class="starRev">
					<span class="starR on">별1</span> <span class="starR on">별2</span> <span
						class="starR on">별3</span> <span class="starR">별4</span> <span
						class="starR">별5</span>
				</div> <span class="text1" id="text1">인생영화입니다 정말....나의 심금을 울렸습니다...</span>
			...
			<li><span>javascript</span>
				...
				<div class="starRev">
					<span class="starR on">별1</span> <span class="starR on">별2</span> <span
						class="starR on">별3</span> <span class="starR on">별4</span> <span
						class="starR">별5</span>
				</div> <span class="text1" id="text1">친구들이랑 재밌게 봤습니다! 또 보러 올께요!!!ㅎㅎ</span>
				<%--<button type="submit" class="btn btn-dark" style="float:right">등록하기</button>--%>
			</li>
			<li><span>jQuery</span>
				<div class="pulldate">
				...
				<div class="starRev">
					<span class="starR on">별1</span> <span class="starR on">별2</span> <span
						class="starR on">별3</span> <span class="starR on">별4</span> <span
						class="starR on">별5</span>
				</div> <span class="text1" id="text1">액션과 재미를 동시에 챙긴 영화였습니다.
					꾸루루루루르르르르르쨈</span> <%-- <button type="submit" class="btn btn-dark" style="float:right">등록하기</button>--%>
			</li>
		</ul>
	</div>
	<!--페이지 넘기기 -->
