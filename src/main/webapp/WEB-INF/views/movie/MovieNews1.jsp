...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/MovieNews1.css?time=<%=System.currentTimeMillis()%>">
	...
	<div class="content">
		...
		<div class="king-row">
			...
			<div class="movie-picture">
				...
				<a
					href="${pageContext.request.contextPath}/movie/movienewsdetail/MovieNewsDetail01.do?time=<%=System.currentTimeMillis()%>"
					class="thumbnail">
					<div class="row">
						<!-- 이미지 영역 -->
			...
			<div class="movie-picture">
				<!-- .thumbnail은 박스에 회색 테두리를 쳐준다. -->
				<a href="${pageContext.request.contextPath}/movie/movienewsdetail/MovieNewsDetail02.do?time=<%=System.currentTimeMillis()%>" class="thumbnail">
					<div class="row">
						<!-- 이미지 영역 -->
			...
			<div class="movie-picture">
				<!-- .thumbnail은 박스에 회색 테두리를 쳐준다. -->
				<a href="${pageContext.request.contextPath}/movie/movienewsdetail/MovieNewsDetail03.do?time=<%=System.currentTimeMillis()%>" class="thumbnail">
					<div class="row">
						<!-- 이미지 영역 -->
			...
			<div class="movie-picture">
				<!-- .thumbnail은 박스에 회색 테두리를 쳐준다. -->
				<a href="${pageContext.request.contextPath}/movie/movienewsdetail/MovieNewsDetail04.do?time=<%=System.currentTimeMillis()%>" class="thumbnail">
					<div class="row">
						<!-- 이미지 영역 -->
			...
			<div class="movie-picture">
				<!-- .thumbnail은 박스에 회색 테두리를 쳐준다. -->
				<a href="${pageContext.request.contextPath}/movie/movienewsdetail/MovieNewsDetail05.do?time=<%=System.currentTimeMillis()%>" class="thumbnail">
					<div class="row">
						<!-- 이미지 영역 -->
			...
			<div class="movie-picture">
				<!-- .thumbnail은 박스에 회색 테두리를 쳐준다. -->
				<a href="${pageContext.request.contextPath}/movie/movienewsdetail/MovieNewsDetail06.do?time=<%=System.currentTimeMillis()%>" class="thumbnail">
					<div class="row">
						<!-- 이미지 영역 -->
			...
			<div class="movie-picture">
				<!-- .thumbnail은 박스에 회색 테두리를 쳐준다. -->
				<a href="${pageContext.request.contextPath}/movie/movienewsdetail/MovieNewsDetail07.do?time=<%=System.currentTimeMillis()%>" class="thumbnail">
					<div class="row">
						<!-- 이미지 영역 -->
			...
			<div class="movie-picture">
				<!-- .thumbnail은 박스에 회색 테두리를 쳐준다. -->
				<a href="${pageContext.request.contextPath}/movie/movienewsdetail/MovieNewsDetail08.do?time=<%=System.currentTimeMillis()%>" class="thumbnail">
					<div class="row">
						<!-- 이미지 영역 -->
...
<script src="${pageContext.request.contextPath}/assets/js_files/pagepass1.js"></script>
