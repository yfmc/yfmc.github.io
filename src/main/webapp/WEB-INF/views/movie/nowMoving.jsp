										...
										<div class="movie-image">
											<span><img src="${k.poster_link}"
												...
												<c:url value="${contextPath}/movie/MovieContent.do" var="movie_content_url">
													...
													<a href="${pageContext.request.contextPath}/booking?movieId=${k.movie_id}&scrnDay=${scrnDay}"
														id="book1">예매하기</a> <a
										...
										<div class="movie-image">
											<span><img
												...
												<c:url value="${contextPath}/movie/MovieContent.do" var="movie_content_url">
													...
													<a href="${pageContext.request.contextPath}/booking?movieId=${k.movie_id}&scrnDay=${scrnDay}" id="book1">예매하기</a>
