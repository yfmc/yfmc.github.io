	...
	<div class="content">
		<div class="list_title">
			...
			<ul>
				...
				<li><a
					href="${pageContext.request.contextPath}/movie/willMoving.do">상영
						예정작</a></li>
			</ul>
			</p>
		</div>
								...
								<div class="movie-image">
									<span><img
										...
										<figcaption>
											...
											<a href="${pageContext.request.contextPath}/movie/MovieContent.do" id="information1">상세정보</a>
										</figcaption> </span>
								</div>
								<!-- 텍스트 영역 -->
							...
							<div class="row">
								...
								<div class="movie-image">
									<span> <img
										...
										class="img-responsive" />
										<figcaption>
											<a href="${pageContext.request.contextPath}/예매페이지" id="book2">예매하기</a>
											<a href="${pageContext.request.contextPath}/movie/MovieContent.do" id="information2">상세정보</a>
										</figcaption>
									</span>
								</div>
								<!-- 텍스트 영역 -->
							...
							<div class="row">
								...
								<div class="movie-image">
									<span> <img
										...
										class="img-responsive" />
										<figcaption>
											<a href="${pageContext.request.contextPath}/예매페이지" id="book3">예매하기</a>
											<a href="${pageContext.request.contextPath}/movie/MovieContent.do" id="information3">상세정보</a>
										</figcaption>
									</span>
								</div>
								<!-- 텍스트 영역 -->
							...
							<div class="row">
								...
								<div class="movie-image">
									<span> <img
										...
										class="img-responsive" />
										<figcaption>
											<a href="${pageContext.request.contextPath}/예매페이지" id="book4">예매하기</a>
											<a href="${pageContext.request.contextPath}/movie/MovieContent.do" id="information4">상세정보</a>
										</figcaption>
									</span>
								</div>
								<!-- 텍스트 영역 -->
							...
							<div class="row">
								...
								<div class="movie-image">
									<span> <img
										...
										class="img-responsive" />
										<figcaption>
											<a href="${pageContext.request.contextPath}/예매페이지" id="book5">예매하기</a>
											<a href="${pageContext.request.contextPath}/movie/MovieContent.do" id="information5">상세정보</a>
										</figcaption>
									</span>
								</div>
								<!-- 텍스트 영역 -->
							...
							<div class="row">
								...
								<div class="movie-image">
									<span> <img
										...
										class="img-responsive" />
										<figcaption>
											<a href="${pageContext.request.contextPath}/예매페이지" id="book6">예매하기</a>
											<a href="${pageContext.request.contextPath}/movie/MovieContent.do" id="information6">상세정보</a>
										</figcaption>
									</span>
								</div>
								<!-- 텍스트 영역 -->
							...
							<div class="row">
								...
								<div class="movie-image">
									<span> <img
										...
										class="img-responsive" />
										<figcaption>
											<a href="${pageContext.request.contextPath}/예매페이지" id="book7">예매하기</a>
											<a href="${pageContext.request.contextPath}/movie/MovieContent.do" id="information7">상세정보</a>
										</figcaption>
									</span>
								</div>
								<!-- 텍스트 영역 -->
							...
							<div class="row">
								...
								<div class="movie-image">
									<span><img
										...
										class="img-responsive" />
										<figcaption>
											<a href="${pageContext.request.contextPath}/예매페이지" id="book8">예매하기</a>
											<a href="${pageContext.request.contextPath}/movie/MovieContent.do" id="information8">상세정보</a>
										</figcaption> </span>
								</div>
								<!-- 텍스트 영역 -->
								<div class="movie-text">
...
<script src="${pageContext.request.contextPath}/assets/js_files/ranking.js"></script>
