						...
						<c:choose>
							...
							<c:otherwise>
								...
								<c:forEach var="item" items="${output}" varStatus="status">
									...
									<c:set var="notice_id" 		value="${item.notice_id}" />
									...
									<%-- 상세페이지로 이동하기 위한 URL --%>
									<c:url value="/support/notice_detail.do" var="viewUrl">
				...
				<div class = "page">
					...
					<c:choose>
						...
						<c:when test="${pageData.prevPage > 0}">
							<%-- 이동할 URL 생성 --%>
							<c:url value="/support/notice_list.do" var="prevPageUrl">
					...
					<c:forEach var="i" begin="${pageData.startPage}"
						...
						<%-- 이동할 URL 생성 --%>
						<c:url value="/support/notice_list.do" var="pageUrl">
					...
					<c:choose>
						...
						<c:when test="${pageData.nextPage > 0}">
							<%-- 이동할 URL 생성 --%>
							<c:url value="/support/notice_list.do" var="nextPageUrl">
...
$(function() {
	$(document).on('click', '.searchButton', function(e) {
		e.preventDefault();
		var url = "${pageContext.request.contextPath}/support/notice_list.do";
